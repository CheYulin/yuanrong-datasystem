...
=======
    ...
    { 36, "zmq_client_queuing_latency", MetricType::HISTOGRAM, "ns" },
    { 37, "zmq_client_stub_send_latency", MetricType::HISTOGRAM, "ns" },
    { 38, "zmq_server_queue_wait_latency", MetricType::HISTOGRAM, "ns" },
    { 39, "zmq_server_exec_latency", MetricType::HISTOGRAM, "ns" },
    { 40, "zmq_server_reply_latency", MetricType::HISTOGRAM, "ns" },
    { 41, "zmq_rpc_e2e_latency", MetricType::HISTOGRAM, "ns" },
    { 42, "zmq_rpc_network_latency", MetricType::HISTOGRAM, "ns" },
    // Alloc/free counters: requested/logical bytes (see Allocator::AllocateMemory/FreeMemory comments).
    { 43, "worker_allocator_alloc_bytes_total", MetricType::COUNTER, "bytes" },
    { 44, "worker_allocator_free_bytes_total", MetricType::COUNTER, "bytes" },
    { 45, "worker_shm_unit_created_total", MetricType::COUNTER, "count" },
    { 46, "worker_shm_unit_destroyed_total", MetricType::COUNTER, "count" },
    { 47, "worker_shm_ref_add_total", MetricType::COUNTER, "count" },
    { 48, "worker_shm_ref_remove_total", MetricType::COUNTER, "count" },
    { 49, "worker_shm_ref_table_size", MetricType::GAUGE, "count" },
    { 50, "worker_shm_ref_table_bytes", MetricType::GAUGE, "bytes" },
    { 51, "worker_remove_client_refs_total", MetricType::COUNTER, "count" },
    { 52, "worker_object_erase_total", MetricType::COUNTER, "count" },
    { 53, "master_object_meta_table_size", MetricType::GAUGE, "count" },
    // Depth of TTL time queue (timedObj_); not a separate count of failedObjects_ retry metadata alone.
    { 54, "master_ttl_pending_size", MetricType::GAUGE, "count" },
    { 55, "master_ttl_fire_total", MetricType::COUNTER, "count" },
    { 56, "master_ttl_delete_success_total", MetricType::COUNTER, "count" },
    { 57, "master_ttl_delete_failed_total", MetricType::COUNTER, "count" },
    { 58, "master_ttl_retry_total", MetricType::COUNTER, "count" },
    { 59, "client_async_release_queue_size", MetricType::GAUGE, "count" },
    { 60, "client_dec_ref_skipped_total", MetricType::COUNTER, "count" },
>>>>>>> Stashed changes
};
