...
enum class KvMetricId : uint16_t {
    ...
    CLIENT_EXIST_REQUEST_TOTAL,
    CLIENT_EXIST_ERROR_TOTAL,
    WORKER_PROCESS_EXIST_LATENCY,
    CLIENT_PUT_SHM_WRITE_TOTAL_BYTES,
    CLIENT_PUT_LOCAL_WRITE_TOTAL_BYTES,
    BRPC_CLIENT_REQ_FRAMEWORK_LATENCY,
    BRPC_REMOTE_PROCESSING_LATENCY,
    BRPC_CLIENT_RSP_FRAMEWORK_LATENCY,
    BRPC_SERVER_REQ_QUEUE_LATENCY,
    BRPC_SERVER_EXEC_LATENCY,
    ...
    CLIENT_GET_SHM_READ_TOTAL_BYTES,
    CLIENT_EXIST_REDIRECT_TOTAL,
    CLIENT_EXIST_CONNECTION_RETRY_TOTAL,
    CLIENT_DIRECT_BATCH_GET_RPC_TOTAL,
    CLIENT_DIRECT_BATCH_GET_OBJECT_TOTAL,
    CLIENT_DIRECT_BATCH_GET_REPLICA_RETRY_TOTAL,
    CLIENT_DIRECT_BATCH_GET_UB_SPLIT_TOTAL,
    CLIENT_DIRECT_BATCH_GET_TCP_FALLBACK_TOTAL,
    CLIENT_CREATE_REQUEST_TOTAL,
    CLIENT_CREATE_ERROR_TOTAL,
    CLIENT_CREATE_ALLOCATED_BYTES,
    WORKER_CREATE_ALLOCATED_BYTES,
    WORKER_KV_EVENT_PUBLISHED_BATCHES_TOTAL,
