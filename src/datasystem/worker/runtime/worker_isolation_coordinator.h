...
struct WorkerIsolationCoordinatorHooks {
    std::function<void(const WorkerAdmissionGateUpdate &)> setTopologyServingAdmission;
...
private:
    void SetTopologyServingAdmission(const WorkerAdmissionGateUpdate &update) const;
