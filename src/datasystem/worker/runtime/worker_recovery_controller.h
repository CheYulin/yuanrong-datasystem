...
public:
    ...
    std::optional<bool> TryCompleteRecovery(WorkerRecoveryGeneration generation, const WorkerRunningEvidence &evidence,
                                            const std::string &detail);

    PreparedRecovery PrepareRecovery(const WorkerRunningEvidence &evidence, const std::string &detail) const;
    std::optional<bool> CommitPreparedRecovery(WorkerRecoveryGeneration generation, const PreparedRecovery &recovery);
    void FinishRecovery() const;
